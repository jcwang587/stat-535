...
# Agenda {-#my-section1}
* Syllabus ([link](https://umass.moonami.com/mod/resource/view.php?id=2196870))
...
# How this class will work {-#my-section2}
* No programming knowledge presumed
* Some statstics knowledge presumed
...
# Installation (R and RStudio)
We assume that you have already installed R (https://www.r-project.org) (R Core Team 2019) and the RStudio IDE (https://www.rstudio.com). RStudio is not required but recommended, because RStudio provides standard open source and enterprise-ready professional software for the R statistical computing environment and makes it easier for an average user to work with R Markdown.
...
&nbsp; <img src="Lecture1_1.png" alt="drawing" height="290"/> &rarr; <img src="Lecture1_2.png" alt="drawing" height="290"/> 
...
``` {r, out.width='100', fig.align='left', echo=FALSE}
     knitr::include_graphics('Lecture1_3.png') 
```
...
<img src="Lecture1_4.png" alt="Volcano Example" height="600"/>
...
<block>
      ...
      &nbsp; &nbsp; &nbsp; &nbsp; ```knitr::include_graphics('Lecture1_fruits.png') ```  
      ```` ``` ````
</block>
