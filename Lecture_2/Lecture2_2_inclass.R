...
# Running example: resource allocation ("Linear programming")
# ====
...
# Data arguments
# ===
# Many functions take `data` arguments, and look variables up in
# that data frame:
