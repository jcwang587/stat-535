...
# Data structures tie related values into one object, and functions tie related commands into one object. In both cases: easier to understand, easier to work with, easier to build into larger things.
